            ...
            <form method="GET" action="<?php echo esc_url(home_url('/ma-search-results')); ?>" class="ma-search-form">
                <div class="search-row">
                    <div class="search-field">
                        <label>キーワード</label>
                        <input type="text" name="keyword" placeholder="企業名で検索" value="<?php echo esc_attr(isset($_GET['keyword']) ? $_GET['keyword'] : ''); ?>">
                    </div>
                    ...
                    <div class="search-field">
                        <label>所在地</label>
                        <input type="text" name="location" placeholder="東京都" value="<?php echo esc_attr(isset($_GET['location']) ? $_GET['location'] : ''); ?>">
                    </div>
                </div>
                ...
                <div class="search-row">
                    <div class="search-field">
                        ...
                        <input type="number" name="capital_min" placeholder="1000" value="<?php echo esc_attr(isset($_GET['capital_min']) ? $_GET['capital_min'] : ''); ?>">
                    </div>
...
if (!function_exists('ma_search_results_shortcode')) {
    function ma_search_results_shortcode() {
        ...
        <div class="ma-results-container">
            <h2>検索結果: <?php echo esc_html($query->found_posts); ?>件</h2>
