...
# ============================================================
# 1. test_tasks_practical.py を完全書き換え
# ============================================================
print("\n1️⃣ test_tasks_practical.py を修正...")

new_test_content = '''#!/usr/bin/env python3
"""
実践的タスクテスト - 完全修正版
"""
import logging
...
# バックアップ
backup = test_path.with_suffix('.py.backup_complete')
...
print("   ✅ test_tasks_practical.py 完全書き換え完了")
...
print("\n📝 変更点:")
print("  - sys import 追加")
print("  - task2: page引数を正しく渡すように修正")
print("  - BrowserControllerからPageオブジェクトを取得")
print("  - 適切なクリーンアップ処理")
