...
try:
    ...
    print("✅ task_executorからTaskExecutorをインポートしました")
except ImportError as e:
    print(f"⚠️ task_executorからTaskExecutorをインポートできません: {e}")
    # 代替実装
    class TaskExecutor:
...
class ProjectManagerAgent:
    ...
    async def execute_priority_tasks(self, priority_tasks):
        ...
        results = []
        for task in priority_tasks[:2]:  # 最大2件まで実行
            try:
