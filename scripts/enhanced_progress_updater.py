...
class EnhancedProgressUpdater:
    ...
    async def update_dashboard(self, analysis, dashboard_data):
        ...
        try:
            ...
            print(f"   完了タスク: {analysis['completed_tasks']}/{analysis['total_tasks']} ({analysis['task_completion_rate']}%)")
    ...
    async def write_to_dashboard(self, analysis):
        ...
        try:
            ...
            if len(existing_data) > 0:
                ...
                # ヘッダーを作成して追加
                headers = ['Timestamp', 'Overall Progress %', 'Active Goals', 'Completed Tasks', 'Total Tasks', 'Completion Rate %', 'Active Goal IDs']
