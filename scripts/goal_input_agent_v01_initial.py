...
class GoalInputAgent:
    ...
    def __init__(self):
        ...
        self.sheets = SheetsManager(
            credentials_path=self.config["credentials_path"], spreadsheet_id=self.config["spreadsheet_id"]
        )
...
def main():
    parser = argparse.ArgumentParser(description="Goal Input Agent - GitHub ActionsからPM Agentへの橋渡し")
