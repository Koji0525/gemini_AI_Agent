...
class ProgressReporter:
    ...
    def generate_daily_report(self):
        ...
        try:
            ...
            credentials = Credentials.from_service_account_file(self.config.get("service_account_file"), scopes=scopes)
    ...
    def get_goals_data(self, spreadsheet):
        ...
        try:
            ...
            return {"total": len(data) - 1, "active": len(active_goals), "active_goals": active_goals}
