...
class AutoScheduler:
    ...
    def __init__(self, config_path: str = "config/schedules/schedule_config.json", log_dir: str = "logs/scheduler"):
    ...
    def load_config(self) -> None:
        ...
        if self.config_path.exists():
            ...
            self.schedules = {
                ...
                "health_check": {"interval_minutes": 30, "enabled": True, "command": "python3 scripts/health_check.py"},
                "backup": {
    ...
    async def run_schedule(self, name: str, schedule: Dict) -> bool:
        ...
        try:
            ...
            proc = await asyncio.create_subprocess_shell(
                schedule["command"], stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE
            )
