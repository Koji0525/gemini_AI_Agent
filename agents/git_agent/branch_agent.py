...
class BranchAgent:
    ...
    def create_and_switch(self, new_branch: str) -> bool:
        ...
        result = subprocess.run(
            ["git", "checkout", "-b", new_branch], cwd=self.project_root, capture_output=True, text=True
        )
    ...
    def switch(self, branch: str) -> bool:
        ...
        result = subprocess.run(["git", "checkout", branch], cwd=self.project_root, capture_output=True, text=True)
