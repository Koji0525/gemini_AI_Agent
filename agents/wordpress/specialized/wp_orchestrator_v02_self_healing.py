...
class WordPressOrchestrator:
    ...
    def __init__(self, design_spec: Dict[str, Any], wp_credentials: Dict = None):
        ...
        self.wp_credentials = wp_credentials or {
            ...
            "username": get_config("WP_USERNAME"),
            "password": get_config("WP_PASSWORD"),
        }
        ...
        try:
            ...
            for step_number, step in enumerate(execution_plan, 1):
                ...
                if step_result["success"]:
                    ...
                    print(
                        f"❌ ステップ {step_number} 失敗: {step_result.get('error', '未知のエラー')}"
                    )
    ...
    def _generate_summary(self, results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "generated_code_summary": {
                "count": len(generated_code),
                "types": list(generated_code.keys()),
            },
...
if __name__ == "__main__":
    ...
    async def test():
        ...
        orchestrator = WordPressOrchestrator(
            test_design,
            {"url": "http://localhost/wordpress", "username": "admin", "password": "password"},
        )
