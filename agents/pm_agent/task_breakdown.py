...
class TaskBreakdownAgent:
    ...
    async def generate_tasks_for_goal(self, goal_id: str, goal_info: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
        目標に対する追加タスクを生成（モック版）
    ...
    def _generate_mock_tasks(
        self, goal_id: str, goal_info: Dict[str, Any], existing_tasks: List[Dict[str, Any]]
    ) -> List[Dict[str, Any]]:
        """
        モックタスクを生成
