...
class ErrorClassifier:
    ...
    ERROR_PATTERNS = {
        'network': [
            r'ConnectionError', r'NetworkError', r'ConnectionRefusedError',
            r'ConnectionResetError', r'Failed to establish', r'Connection refused'
        ],
        'timeout': [
            r'TimeoutError', r'asyncio\.TimeoutError', r'ReadTimeout',
            r'ConnectTimeout', r'timeout.*exceeded', r'timed out'
        ],
        'rate_limit': [
            r'429', r'Too Many Requests', r'Rate limit exceeded',
            r'ResourceExhausted', r'Quota exceeded'
        ],
        'auth': [
        ...
        'selector': [
            r'NoSuchElementException', r'ElementNotFound',
            r'Selector not found', r'Element .* not found'
        ],
        'api_error': [
            r'400', r'Bad Request', r'Invalid request',
    ...
    def get_suggested_wait_time(self, error: Exception) -> float:
        ...
        error_type = self.classify(error)
        wait_times = {
            'network': 2.0, 'timeout': 1.0, 'rate_limit': 60.0,
            'auth': 5.0, 'selector': 2.0, 'api_error': 5.0, 'unknown': 3.0
        }
