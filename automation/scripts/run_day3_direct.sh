...
# Day 3: 企業データ実登録実行スクリプト - 直接入力版

echo "🚀 Day 3 企業データ実登録開始 (直接入力版 V9)"
echo "=========================================="

# 構文チェック
echo "🔧 構文チェック中..."
python3 -m py_compile automation/modules/wp_data_populator_v9_direct.py
if [ $? -ne 0 ]; then
    echo "❌ 構文エラーがあります"
    exit 1
fi
...
python3 automation/modules/wp_data_populator_v9_direct.py
...
if [ $EXIT_CODE -eq 0 ]; then
    echo ""
    echo "🎉 Day 3 完了！"
    echo "📊 結果確認: automation/logs/day3/registration_results_v9.json"
    echo ""
    ...
    echo "📄 詳細ログ: automation/logs/day3/registration_results_v9.json"
fi
