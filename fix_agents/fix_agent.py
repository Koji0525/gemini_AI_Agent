...
class BaseFixAgent(ABC):
    ...
    def __init__(self, command_monitor=None, wp_tester=None, **kwargs):
        """
        初期化
        ...
        # 統計情報
        self.stats = {"total_fixes": 0, "successful_fixes": 0, "failed_fixes": 0}
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {**self.stats, "success_rate": success_rate, "agent_name": self.agent_name}

    def _create_failed_result(self, task_id: str, error_message: str, start_time: datetime):
        """失敗結果を作成"""
