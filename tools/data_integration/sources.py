...
class DataSourceRegistry:
    ...
    def _register_sources(self):
        ...
        if sources_config.get("conversation_logs", {}).get("enabled", False):
            self.sources.append(ConversationLogsSource(sources_config["conversation_logs"], self.sheets_manager))

        # SpreadsheetLogsSource
        if sources_config.get("spreadsheet_logs", {}).get("enabled", False):
            self.sources.append(SpreadsheetLogsSource(sources_config["spreadsheet_logs"], self.sheets_manager))
