...
# 同期対象のシート設定
SYNC_SHEETS = {"progress_dashboard": True, "project_goal": True, "pm_tasks": True}

# 通知設定
NOTIFICATIONS = {"on_success": True, "on_error": True, "log_level": "INFO"}  # DEBUG, INFO, WARNING, ERROR
